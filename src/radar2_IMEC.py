...
def main():
    radar1 = radar_interface(TCP_IP, 4660)
    ctr = 1
    
    # ROS Startup
    rospy.init_node('radar_2_publisher', anonymous=True)
    radar1_pub = rospy.Publisher("/radar_2", radar, queue_size=10)
    ...
    try:
        ...
        print("Couldn't connect radar 2")
    try:
